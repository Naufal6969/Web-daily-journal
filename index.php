    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://logos-world.net/wp-content/uploads/2021/09/NFL-Logo.png" class="img-fluid" width="300" />
          <div>
...
<style>
  ...
  .carousel-item:hover .carousel-caption {
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://logos-world.net/wp-content/uploads/2021/09/NFL-Logo.png"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14939</h3>
            <h1 class="fw-bold">Naufal Risqi Nurida</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>Naufal Risqi Nurida &copy; 2025</div>
    </footer>
    <!-- footer end -->
